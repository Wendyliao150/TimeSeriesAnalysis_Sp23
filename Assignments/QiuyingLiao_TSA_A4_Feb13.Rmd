...
*The p value for SMK test is less than 0.05, showing that it reject the null hypothesis and there is deterministic trend
...
#my_date <- paste(energy_data_df[,1])

#print("Results from Spearman Correlation")
#sp_rho=cor(energy_data_yearly,year,method="spearman")
#print(sp_rho)
