...
deseasonal_residential_price <- seasadj(decompose_residential_price)  #seasonal adjustment to your original data, only works for decompose  
...
# we remove those little spikes for the seasonality (left, downside)
