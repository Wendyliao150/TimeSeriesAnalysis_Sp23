...
* ETS (has 2 seasonal component going on)
* ARIMA with dynamic harmonic fourier components
* TBATS
* Neural Network (it cannot work in knit in pdf)
...
ARIMA_Four_fit <- auto.arima(ts_act_power_daily_train, 
                             seasonal=FALSE, 
                             lambda=0, #asking my variable into normal distribution
                             xreg=fourier(ts_act_power_daily_train, 
                                          K=c(2,12)) #2 is weekly pattern #12 is monthly pattern
                             )
...
ARIMA_Four_for <- forecast(ARIMA_Four_fit,
                           xreg=fourier(ts_act_power_daily_train,
                                        K=c(2,12), #at least 2 otherwise there is no seasonality
                                        h=365),
                           h=365
                           ) 
...
### Model 3: TBATS (improvement of es function, can do double seasonality)
...
#box-cox: help you transfer variables to normal distribution before fitting into the model. 
